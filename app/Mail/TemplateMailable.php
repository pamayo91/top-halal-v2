...
{
    use Queueable;
    public function __construct(public string $templateKey, public array $values, public ?int $logId = null, public ?string $replyTo = null) {}
    ...
    public function build(): static { $mailer=app(MailSettings::class)->apply(); $this->mailer($mailer); if ($this->replyTo) $this->replyTo($this->replyTo); if ($this->logId) EmailDeliveryLog::whereKey($this->logId)->update(['attempts'=>\DB::raw('attempts + 1'),'last_attempt_at'=>now()]); return $this; }
