...
class QuickRestaurantMatcher
{
    ...
    {
        $candidates = $restaurants->map(fn (Restaurant $restaurant) => ['restaurant' => $restaurant, 'score' => $this->score($quick, $restaurant)])
    ...
    public function score(array $q, Restaurant $r): int
    {
        ...
        elseif ($this->similar($q['quick_name'], $r->name) >= 85) $score += 25;
