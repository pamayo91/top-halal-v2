...
{
 protected static ?string $model=RestaurantReview::class; protected static ?string $recordTitleAttribute='author_name'; protected static string|null|\BackedEnum $navigationIcon='heroicon-o-star'; protected static string|\UnitEnum|null $navigationGroup='Communauté'; protected static ?int $navigationSort=1; protected static ?string $navigationLabel='Avis';
