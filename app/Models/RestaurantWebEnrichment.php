...
class RestaurantWebEnrichment extends Model
{
    ...
    protected $guarded = [];
    protected function casts(): array { return ['sources'=>'array','description_sources'=>'array','closure_sources'=>'array','hours_before'=>'array','hours_after'=>'array','processed_at'=>'datetime','processing_started_at'=>'datetime']; }
