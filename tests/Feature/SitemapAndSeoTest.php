...
class SitemapAndSeoTest extends TestCase
{
    ...
    public function test_sitemap_contains_only_canonical_public_urls(): void
    {
        ...
        $this->get('/sitemap.xml')->assertOk()->assertHeader('Content-Type', 'application/xml; charset=UTF-8')->assertSee(route('restaurants.show', 'le-test'), false)->assertDontSee(route('editorial.show', 'private'), false);
    }
