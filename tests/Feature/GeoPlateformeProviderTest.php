...
class GeoPlateformeProviderTest extends TestCase
{
    ...
    {
        Cache::flush();
        Http::fake(['https://data.geopf.fr/geocodage/search*' => Http::response(['features' => [['properties' => ['label' => '1 rue Test 75001 Paris', 'score' => 0.99, 'type' => 'housenumber', 'id' => '75101_0001_00001', 'postcode' => '75001', 'city' => 'Paris', 'citycode' => '75101'], 'geometry' => ['coordinates' => [2.35, 48.85]]]])]);
