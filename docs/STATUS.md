...
| Admin/moderation | DONE (local implementation) | `/bo` protégé par rôle actif, dashboard, CRUD/modération, médiathèque, redirections, taxonomies, réglages et audit; validation préproduction Playwright reste à exécuter après déploiement. |
