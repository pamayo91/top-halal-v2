...
| Legacy DB import connection | BLOCKED | Read-only legacy connection is configured via env placeholders; real legacy DB credentials/import status are not available yet |
