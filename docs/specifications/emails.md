...
## Implemented events
- Email verification, password reset, password-change confirmation, claim received/accepted/refused, restaurant-submission receipt and restaurant-publication notifications use central templates.
