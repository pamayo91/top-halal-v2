...
- The login, forgotten-password and password-change pages use the same responsive public form-card language as restaurant claims and public restaurant proposals: calm tinted background, centred card, editorial hierarchy, icon-assisted fields and full-width action.
