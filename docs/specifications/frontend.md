...
- `/contact` est une page SSR légère : nom, e-mail, sujet et message, CSRF, validation serveur, honeypot et limite de débit. La confirmation ne dépend jamais de SMTP.
