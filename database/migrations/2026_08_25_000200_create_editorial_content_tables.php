...
return new class extends Migration {
 public function up(): void {
  ...
  Schema::create('content_media', function(Blueprint $t): void {$t->id();$t->string('content_type',10);$t->unsignedBigInteger('content_id');$t->unsignedBigInteger('legacy_attachment_id');$t->string('legacy_path')->nullable();$t->string('role',20)->default('featured');$t->timestamps();$t->unique(['content_type','content_id','legacy_attachment_id','role'],'content_media_legacy_unique');});
 }
