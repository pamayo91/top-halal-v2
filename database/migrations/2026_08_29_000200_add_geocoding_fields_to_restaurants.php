...
return new class extends Migration {
    ...
    public function down(): void { Schema::table('restaurants', function (Blueprint $t): void { $t->dropIndex('restaurants_geo_status_coordinates_index'); $t->dropIndex(['city_code']); $t->dropColumn(['address_line1','address_line2','country_code','city_code','geocoding_provider','geocoding_source_id','geocoding_precision','geocoding_status','geocoding_score','geocoding_distance_m','geocoding_review_reason','geocoded_at','manually_verified_at']); }); }
};
