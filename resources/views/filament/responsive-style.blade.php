<style id="fi-admin-responsive">
    ...
    .menu-editor__handle { color:var(--gray-400); cursor:grab; font-size:1.1rem; }.menu-editor__destination { overflow:hidden; color:var(--gray-500); text-overflow:ellipsis; white-space:nowrap; }.menu-editor__visibility { color:var(--gray-500); white-space:nowrap; }.menu-editor__actions { display:flex; flex-wrap:wrap; justify-content:flex-end; gap:.25rem; }.menu-editor__actions button { border:0; border-radius:.35rem; background:transparent; padding:.25rem .35rem; color:var(--primary-600); font:inherit; font-size:.78rem; cursor:pointer; }.menu-editor__actions button:hover { background:var(--primary-50); }.menu-editor__actions button:disabled { color:var(--gray-400); cursor:not-allowed; }.menu-editor__actions .menu-editor__delete { color:var(--danger-600); }.menu-editor__empty { padding:1rem; color:var(--gray-500); }
